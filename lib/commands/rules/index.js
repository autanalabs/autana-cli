        ...
        return yargs
            ...
            .command('create <actionId>', 'Create a new project rule', (yargs) => {
                ...
                */
                ...
                .option('authorization-rule', {
                    description: 'A JSONata Boolean expression for authorization',
                    alias: 'ar',
                    type: 'string',
                    required: false
                });
            ...
            .command('update <actionId>', 'Update a existent project rule', (yargs) => {
                return yargs
                .option('projectId', {
                    description: 'A valid Appwrite projectID',
                    alias: 'p',
            ...
            .command('remove <actionId>', 'Remove a project rule', (yargs) => {
                return yargs
                .option('projectId', {
                    description: 'A valid Appwrite projectID',
                    alias: 'p',
